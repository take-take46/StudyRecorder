...
export default function TypingPage() {
  ...
  const [includeImportance, setIncludeImportance] = useState(true);
    ...
    <div className="max-w-5xl mx-auto animate-fadeIn">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-800 mb-2">タイピング練習</h1>
            <p className="text-gray-600">中小企業診断士試験の用語でタイピングスキルを向上させましょう</p>
          </div>
          <a 
            href="/"
