export default function SMEConsultantHome() {
  return (
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group">
            <div className="bg-gradient-to-r from-yellow-400 to-orange-500 p-6 text-white">
              ...
              <h3 className="text-xl font-bold mb-2">合格発表</h3>
              <p className="text-yellow-100 text-sm">2025年度合格おめでとう！</p>
            </div>
            <div className="p-6">
              <ul className="text-sm text-gray-600 mb-6 space-y-2">
                <li className="flex items-center"><span className="text-yellow-500 mr-2">✓</span>合格証明書表示</li>
                <li className="flex items-center"><span className="text-yellow-500 mr-2">✓</span>総合結果確認</li>
                <li className="flex items-center"><span className="text-yellow-500 mr-2">✓</span>お祝いアニメーション</li>
              </ul>
              <a 
                href="/congratulations"
                className="block w-full text-center bg-yellow-500 text-white py-3 rounded-lg hover:bg-yellow-600 transition-colors font-semibold"
              >
                合格を祝う
              </a>
            </div>
